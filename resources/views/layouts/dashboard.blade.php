                ...
                <div class="row" style="padding-left:40px">
                    ...
                    <div class="col-lg-5 col-6">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="{{ url('showAreas') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-5 col-6" style="margin-right: 90px">
                        ...
                        <div class="card direct-chat direct-chat-primary">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/28/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ url('/dashboard/dist/img/user7-128x128.jpg') }}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/20/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ url('/dashboard/dist/img/user5-128x128.jpg') }}">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">1/27/2015</small>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="{{ url('/dashboard/dist/img/user8-128x128.jpg') }}">
